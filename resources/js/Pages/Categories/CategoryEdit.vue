<template>
  <InertiaHead title="Editar categoría" />
  <div class="card">
    <div class="card-body">
      ...
      <form @submit.prevent="submit">
        ...
        <div class="mb-3">
          ...
          <div v-for="(subcategory, index) in form.subcategories" :key="index" class="d-flex mb-2">
            <input type="text" v-model="subcategory.name" class="form-control me-2"
        ...
        <div class="d-flex justify-content-end mt-4">
          <button type="submit" class="btn btn-block bg-success me-2 text-white">Actualizar</button>
          <Link href="/categories" class="btn btn-secondary">Cancelar</Link>
        </div>
      </form>
    </div>
  </div>
...
import { Link, InertiaHead, useForm } from '@inertiajs/inertia-vue3'
